...
Welcome to **`fkc1e100/org-mono-repo`**, the centralized monorepo containing multi-cluster GKE fleet infrastructure configurations, failure-triage workloads, RBAC policies, and event monitoring scripts.
...
│       ├── cluster-06, 07, 10
│       ├── complex-03/       # Artifact Registry Auth & SA Token Lockout
│       ├── complex-04/       # PodAntiAffinity + CNI IP Starvation + GCP ILB
│       └── complex-05/       # PD RWO Multi-Attach & Unprivileged Sysctl
├── manifests/
