...
## 🌐 Global Enterprise Fleet Topology & Multi-Cluster Hierarchy

For a complete map of all 17 GKE clusters, companion GCE VM infrastructure, shared CloudSQL/KMS infrastructure, and cross-domain networking across **Europe, Asia-Pacific, and Americas**, refer to the canonical topology guide:

👉 **[`docs/FLEET_TOPOLOGY.md`](docs/FLEET_TOPOLOGY.md)**
